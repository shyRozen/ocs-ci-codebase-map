...
| Dir | Files | Tests |
|-----|-------|-------|
| test_upgrade.py/ | 1 | 11 |
| test_configuration.py/ | 1 | 6 |
| test_ms_upgrade.py/ | 1 | 5 |
| test_noobaa.py/ | 1 | 5 |
| test_resources.py/ | 1 | 4 |
| test_monitoring_after_ocp_upgrade.py/ | 1 | 2 |
| test_upgrade_precheck_ceph_health.py/ | 1 | 2 |
...
| File | Tests | Squad |
|------|-------|-------|
| test_upgrade.py | 11 | purple_squad |
| test_configuration.py | 6 | brown_squad |
| test_ms_upgrade.py | 5 | yellow_squad |
| test_noobaa.py | 5 | red_squad |
| test_resources.py | 4 | brown_squad |
| test_monitoring_after_ocp_upgrade.py | 2 | magenta_squad |
| test_upgrade_precheck_ceph_health.py | 2 | brown_squad |
