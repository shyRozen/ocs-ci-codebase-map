...
test_files: 5
test_functions: 8
tiers: {tier1: 2, tier4: 1, tier4a: 1}
---
...
| Dir | Files | Tests |
|-----|-------|-------|
| test_encryption_keyrotation.py/ | 1 | 3 |
| test_encryption_configuration_dashboard.py/ | 1 | 2 |
...
| File | Tests | Squad |
|------|-------|-------|
| test_encryption_keyrotation.py | 3 | green_squad |
| test_encryption_configuration_dashboard.py | 2 | green_squad |
