...
| test_create_multiple_sc_with_same_pool_name.py | 1 | green_squad |
| test_create_sc_and_make_it_as_a_default.py | 1 | green_squad |
| test_create_sc_reclaim_policy_rep2_comp.py | 1 | green_squad |
| test_create_storageclass_with_wrong_provisioner.py | 1 | green_squad |
