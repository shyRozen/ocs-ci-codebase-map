...
| test_create_scale_pods_and_pvcs_using_kube_job.py | 7 | orange_squad |
| test_vm_snapshot_cloning_ops.py | 4 | magenta_squad |
...
| test_cnv_mon_osd_failure.py | 2 | magenta_squad |
