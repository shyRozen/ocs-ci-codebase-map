...
|-----|-------|-------|
| multicluster/ | 3 | 9 |
| test_mcg_replication_with_disruptions.py/ | 1 | 3 |
...
| test_cluster_wide_key_rotation_systemtest.py/ | 1 | 1 |
| test_full_cluster_health.py/ | 1 | 1 |
| test_graceful_nodes_shutdown.py/ | 1 | 1 |
| test_mcg_bucket_notification.py/ | 1 | 1 |
...
| test_mcg_replication_with_disruptions.py | 3 | magenta_squad |
...
| test_cluster_wide_key_rotation_systemtest.py | 1 | magenta_squad |
