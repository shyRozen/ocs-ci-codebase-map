...
| noobaa/ | 12 | 18 |
| upgrade/ | 3 | 6 |
| test_scale_12_OCS_worker_nodes_and_6000_PVCs.py/ | 1 | 5 |
| test_scale_3_OCS_worker_nodes_and_1500_PVCs.py/ | 1 | 3 |
| test_pvc_creation_deletion_scale.py/ | 1 | 2 |
| test_scale_amq.py/ | 1 | 2 |
...
| test_scale_osds_fill_75%_reboot_workers.py/ | 1 | 1 |
| test_scale_pgsql.py/ | 1 | 1 |
...
| File | Tests | Squad |
|------|-------|-------|
| test_scale_12_OCS_worker_nodes_and_6000_PVCs.py | 5 | orange_squad |
| test_scale_obc_creation.py | 3 | orange_squad |
| test_scale_3_OCS_worker_nodes_and_1500_PVCs.py | 3 | orange_squad |
...
| test_scale_amq.py | 2 | orange_squad |
