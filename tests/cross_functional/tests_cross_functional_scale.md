...
| noobaa/ | 10 | 16 |
| upgrade/ | 3 | 6 |
| test_scale_12_OCS_worker_nodes_and_6000_PVCs.py/ | 1 | 3 |
...
| File | Tests | Squad |
|------|-------|-------|
| test_list_objects.py | 3 | orange_squad |
| test_scale_12_OCS_worker_nodes_and_6000_PVCs.py | 3 | orange_squad |
| test_delete_objects.py | 2 | orange_squad |
